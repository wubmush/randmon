...
class Pokemon:
    def __init__(self, name, type1, type2, hp, attack, defense, sp_attack, sp_defense, speed, ability, colour):
        self.name = name
        self.type1 = type1
        self.type2 = type2
        self.hp = hp
...
def generate_pokemon():
 ...
 "Water Veil", "Weak Armor", "White Smoke", "Wimp Out", "Wonder Guard", "Wonder Skin", "Zen Mode"]
    ...
    return Pokemon(name, type1, type2, hp, attack, defense, sp_attack, sp_defense, speed, ability, colour)
